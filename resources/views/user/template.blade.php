...
<html lang="en">
    <head>
        ...
        {{-- <link rel="stylesheet" href="{{ url('assets/css/progress-arc.css') }}"> --}}
            ...
            <div class="row bg-black fixed-top" id="navigation">
                ...
                <div class="col-5 col-md-4 text-end ps-0 py-3">
                    ...
                    <button class="btn btn-outline-success me-3" data-bs-toggle="modal" data-bs-target="#loginModal">
                        <i class="fa-solid fa-wallet"></i><span class="d-none d-md-inline"> Connect Wallet</span>
                    </button>
                </div>
            </div>
            ...
            <div class="d-flex">
                <div class="flex-grow-1 flex-shrink-0 border-right-white" id="sidebar" style="display: none">
                    <div class="nav-content flex-column">
                        <a href="https://hub.komoverse.dev" target="_blank">
                    ...
                    <div class="nav-content flex-column">
                        <a class="nav-link" href="{{ url('telyu-racer') }}#tournament">
                            <img src="{{ url('assets/img/telyu/logo.png') }}" alt="">
                            Telyu Racer
                            <span class="timer">1 day</span>
                        </a>
                        <a class="nav-link" href="{{ url('telyu-racer') }}#tournament">
                            <img src="{{ url('assets/img/telyu/logo.png') }}" alt="">
                            Telyu Racer
                            <span class="timer">7 days</span>
                        </a>
                        <a class="nav-link" href="{{ url('komochess') }}#tournament">
                            <img src="{{ url('assets/img/komochess/icon.jpg') }}" alt="">
                            KomoChess
                            <span class="timer">24 days</span>
                        </a>
                    </div>
                    <div class="nav-title">
                    ...
                    <div class="nav-content flex-column">
                        <a class="nav-link" href="{{ url('komochess') }}#play">
                            <img src="{{ url('assets/img/komochess/icon.jpg') }}" alt="">
                            KomoChess
                        </a>
                        <a class="nav-link" href="{{ url('telyu-racer') }}#play">
                            <img src="{{ url('assets/img/telyu/logo.png') }}" alt="">
                            Telyu Racer
                        </a>
                ...
                <div class="flex-shrink-1" id="main-content">
                    @yield('content')
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-6 p-5 bg-dark text-light left-login">
                                <form action="https://hub.komoverse.dev/login" method="POST">
                                    <input type="hidden" name="_token" value="JoiSTYt2sgH0tJNkYC3Utg6DzL7cs3PnhwiexygV">                <h4>KOMO Account</h4>
                                    Username
                                    ...
                                    <div class="row">
                                        <div class="col pe-1">
                                            <button class="btn form-control btn-success"><i class="fas fa-sign-in-alt" aria-hidden="true"></i> &nbsp; Login</button>
                                        </div>
                                        <div class="col ps-1">
                                            <a href="https://hub.komoverse.dev/register" class="btn form-control btn-outline-success"><i class="fas fa-edit" aria-hidden="true"></i> &nbsp; Register</a>
                                        </div>
                                    </div>
                                </form>
                                <a href="https://hub.komoverse.dev/forgot-password">Lost your password?</a>
                            ...
                            <div class="col-12 col-md-6 p-5 bg-dark text-light">
                                ...
                                <a href="https://hub.komoverse.dev/auth/google" class="btn mt-2 form-control btn-sso btn-google">
                                    <i class="fab fa-google" aria-hidden="true"></i> Login with Google
                                </a>
                                <a href="https://hub.komoverse.dev/auth/facebook" class="btn mt-2 form-control btn-sso btn-facebook">
                                    <i class="fab fa-facebook" aria-hidden="true"></i> Login with Facebook
                                </a>
                                <a href="https://hub.komoverse.dev/auth/twitter" class="btn mt-2 form-control btn-sso btn-twitter">
